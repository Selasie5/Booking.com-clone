  ...
  return (
    <main className="bg-[#013B94]">
     <section className="max-w-7xl mx-auto p-6">
      ...
      <h3 className="text-white py-5 text-xl">Search low proces on hostels, homes and much more ...</h3>
      </section>
          ...
          <div className="flex space-x-4 py-5 overflow-x-scroll">
            {trending_data.map((item)=>(
              <div key={item.id} className="space-y-1 shrink-0 cursor-pointer">
                <Image src={item.src} width={150} height={150} alt="" className="w-80 h-72 object-cover rounded-lg pb-2"/>
